...
var dynamicTable = (function() {
    ...
    function format(item){
            var tagcolor = '<tr>';
            switch (item){
                case 4:tagcolor = '<tr bgcolor = " #00FF7F">';break;
                case 2:
                case 3:tagcolor = '<tr bgcolor = "#FFFF00">';break;
                case 0:
                case 1:tagcolor = '<tr bgcolor = "#FF0000">';break;
...
var newTable =   (function(){
  $.ajax({ url: "/orders", success: function(data){
    //console.log(data);
    dt.load(data)
  }, dataType: "json"});
